...
struct ClosingZone: View {
    @Binding var circleCenter: CGPoint
...
#Preview {
    ZStack {
        Image("grass-stone")
            .resizable()
            .edgesIgnoringSafeArea(.all)
        ClosingZone(circleCenter: Binding.constant(CGPoint(x: 1000, y: 1500)), circleRadius: Binding.constant(1000))
    }
}
